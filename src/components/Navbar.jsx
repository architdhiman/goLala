  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      <div className="container mx-auto px-4 py-4 flex items-center">
        ...
        {/* search */}
        <div className="w-full max-w-xs xl:max-w-lg 2xl:max-w-2xl bg-gray-100 rounded-md hidden lg:flex">
          <select
            className="bg-transparent uppercase font-bold text-sm p-4 mr-4 lg:hidden xl:block"
            name=""
            id=""
          >
        ...
        <nav className="contents">
          <ul className="ml-4 xl:w-48 flex items-center justify-end">
            ...
            <li className="ml-2 lg:ml-4 relative inline-block">
              <a className="" href="">
               <div className="absolute -top-1 right-0 z-10 bg-primary-lite text-xs font-bold px-1 py-0.5 rounded-sm">
                  3
                </div>
                <svg
                  className="h-9 lg:h-10 p-2 text-gray-500"
